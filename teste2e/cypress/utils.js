...
const PROPOSAL_SUMMARY_STATUS_UNVETTED = "unvetted";
const PROPOSAL_SUMMARY_STATUS_UNVETTED_ABANDONED = "unvetted-abandoned";
const PROPOSAL_SUMMARY_STATUS_UNVETTED_CENSORED = "unvetted-censored";
const PROPOSAL_SUMMARY_STATUS_UNDER_REVIEW = "under-review";
const PROPOSAL_SUMMARY_STATUS_ABANDONED = "abandoned";
const PROPOSAL_SUMMARY_STATUS_CENSORED = "censored";
const PROPOSAL_SUMMARY_STATUS_VOTE_AUTHORIZED = "vote-authorized";
const PROPOSAL_SUMMARY_STATUS_VOTE_STARTED = "vote-started";
const PROPOSAL_SUMMARY_STATUS_REJECTED = "rejected";
export const PROPOSAL_SUMMARY_STATUS_ACTIVE = "active";
const PROPOSAL_SUMMARY_STATUS_COMPLETED = "completed";
const PROPOSAL_SUMMARY_STATUS_CLOSED = "closed";
