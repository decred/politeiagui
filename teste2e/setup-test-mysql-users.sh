...
politeiawww_dbutil -mysql -password $MYSQL_ROOT_PASSWORD  -testnet -setadmin adminuser true
politeiawww_dbutil -mysql -password $MYSQL_ROOT_PASSWORD -testnet -addcredits adminuser 100

#User1 with one credit
pictl usernew user1@example.com user1 password --verify
politeiawww_dbutil -mysql -password $MYSQL_ROOT_PASSWORD -testnet -addcredits user1 1
