...
const api = (state = DEFAULT_STATE, action) => (({
  ...
  [act.GRANT_SUBMIT_PROPOSAL_ACCESS]: () => ({...state, verifyPaywallPayment: {grant_access: true} }),
  [act.DENY_SUBMIT_PROPOSAL_ACCESS]: () => ({...state, verifyPaywallPayment: {grant_access: false} }),
