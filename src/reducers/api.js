...
const api = (state = DEFAULT_STATE, action) => (({
  ...
  [act.REQUEST_VERIFY_PAYWALL_PAYMENT_EXPLORER]: () => request("verifyPaywallPaymentExplorer", state, action),
  [act.RECEIVE_VERIFY_PAYWALL_PAYMENT_EXPLORER]: () => receive("verifyPaywallPaymentExplorer", state, action),
  [act.REQUEST_VERIFY_PAYWALL_PAYMENT_POLITEIA]: () => request("verifyPaywallPaymentPoliteia", state, action),
  [act.RECEIVE_VERIFY_PAYWALL_PAYMENT_POLITEIA]: () => receive("verifyPaywallPaymentPoliteia", state, action),
