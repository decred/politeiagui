...
const api = (state = DEFAULT_STATE, action) => (({
  ...
  [act.REQUEST_VERIFY_PAYWALL_PAYMENT_SERVER]: () => request("verifyPaywallPaymentServer", state, action),
  [act.RECEIVE_VERIFY_PAYWALL_PAYMENT_SERVER]: () => receive("verifyPaywallPaymentServer", state, action),
