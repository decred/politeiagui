...
const api = (state = DEFAULT_STATE, action) => (({
  ...
  [act.REQUEST_NOTIFICATIONS]: () => request("notifications", state, action),
  [act.RECEIVE_NOTIFICATIONS]: () => receive("notifications", state, action),
  [act.REQUEST_CHECK_NOTIFICATIONS]: () => request("notifications", state, action),
  [act.RECEIVE_CHECK_NOTIFICATIONS]: () => receive("notifications", state, action),
