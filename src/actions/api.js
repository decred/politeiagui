...
export const onInit = () => dispatch => {
  ...
  return api.me()
    .then(response => dispatch(act.RECEIVE_ME(response)))
    .catch(() => {
...
export const redirectedFrom = location => dispatch => dispatch(act.REDIRECTED_FROM(location));
export const resetRedirectedFrom = () => dispatch => dispatch(act.RESET_REDIRECTED_FROM());
...
export const onForgottenPasswordRequest = ({ email }) =>
  withCsrf((dispatch, getState, csrf) => {
    ...
    return api
      ...
      .then(response => dispatch(act.RECEIVE_FORGOTTEN_PASSWORD_REQUEST(response)))
      .catch(error => {
...
export const resetForgottenPassword = () => dispatch => dispatch(act.RESET_FORGOTTEN_PASSWORD_REQUEST());

export const onPasswordResetRequest = ({ email, verificationtoken, password }) =>
  withCsrf((dispatch, getState, csrf) => {
    dispatch(act.REQUEST_PASSWORD_RESET_REQUEST({ email, verificationtoken, password }));
    return api
...
export const resetPasswordReset = () => dispatch => dispatch(act.RESET_PASSWORD_RESET_REQUEST);
