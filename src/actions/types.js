...
export const REQUEST_VERIFY_PAYWALL_PAYMENT_EXPLORER = "REQUEST_VERIFY_PAYWALL_PAYMENT_EXPLORER";
export const RECEIVE_VERIFY_PAYWALL_PAYMENT_EXPLORER = "RECEIVE_VERIFY_PAYWALL_PAYMENT_EXPLORER";
export const REQUEST_VERIFY_PAYWALL_PAYMENT_POLITEIA = "API_REQUEST_VERIFY_PAYWALL_PAYMENT_POLITEIA";
export const RECEIVE_VERIFY_PAYWALL_PAYMENT_POLITEIA = "API_RECEIVE_VERIFY_PAYWALL_PAYMENT_POLITEIA";
