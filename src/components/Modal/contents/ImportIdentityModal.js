...
const ImportIdentityModal = ({ closeAllModals }) => (
  <ModalContentWrapper
    ...
    <div style={{ width: "100%", padding: "1em", display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column" }}>
      <PrivateKeyImportManager />
      <h2 style={{ fontSize: "1.25em", width: "100%", textAlign: "center", padding: "1em" }}>Or Paste in Your Own</h2>
