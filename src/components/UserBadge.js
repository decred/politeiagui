...
import {
  PAYWALL_STATUS_PAID, PAYWALL_STATUS_LACKING_CONFIRMATIONS, PAYWALL_STATUS_WAITING
} from "../constants";
    ...
    <div style={{ display: "flex", flexDirection: "row",         justifyContent: "center" }}>
      <div class="col-sm-1">
        <Tooltip
          ...
          position="bottom"
        >
          <div class="roundbadge-grey hollow">
            <span className="fa fa-user-times fa-lg grey" aria-hidden="true"></span>
          </div>
        </Tooltip>
      </div>
    </div>
    ...
    <div style={{ display: "flex", flexDirection: "row",         justifyContent: "center" }}>
      <div class="col-sm-1">
        <Tooltip
          ...
          position="bottom"
        >
          <div class="roundbadge-waiting hollow">
            <span className="fa fa-user-times fa-lg" aria-hidden="true"></span>
          </div>
        </Tooltip>
      </div>
    </div>
    ...
    <div style={{ display: "flex", flexDirection: "row",         justifyContent: "center" }}>
      <div class="col-sm-1">
        <Tooltip
          ...
          position="bottom"
        >
          <div class="roundbadge-paid hollow">
