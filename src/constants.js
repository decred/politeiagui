...
export const NOTIFICATION_MY_PROPOSAL_STATUS_CHANGE = 1 << 0;
export const NOTIFICATION_MY_PROPOSAL_VOTE_STARTED = 1 << 1;

export const NOTIFICATION_ADMIN_PROPOSAL_NEW = 1 << 0;
export const NOTIFICATION_ADMIN_PROPOSAL_VOTE_AUTHORIZED = 1 << 1;

export const NOTIFICATION_REGULAR_PROPOSAL_VETTED = 1 << 0;
export const NOTIFICATION_REGULAR_PROPOSAL_EDITED = 1 << 1;
export const NOTIFICATION_REGULAR_PROPOSAL_VOTE_STARTED = 1 << 2;
