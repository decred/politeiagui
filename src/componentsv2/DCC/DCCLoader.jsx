...
const ExtraSmallContentLoader = ({ extended, yOffset, primaryColor, secondaryColor }) => (
  <ContentLoader
...
const RegularContentLoader = ({ extended, yOffset, primaryColor, secondaryColor }) => (
  <ContentLoader
...
const DccLoader = ({ extended }) => {
  ...
  return (
    <RecordWrapper>
      {() =>
        extraSmall ? (
          <ExtraSmallContentLoader {...{ extended, yOffset, primaryColor, secondaryColor }}/>
        ) : (
          <RegularContentLoader {...{ extended, yOffset, primaryColor, secondaryColor }}/>
        )
      }
    </RecordWrapper>
  );
